...
class TrainOptions():
    def initialize(self):
        ...
        parser.add_argument("--model", type=str, default='ENet', help="available options : DeepLab and VGG")
        ...
        parser.add_argument("--snapshot-dir", type=str, default='../checkpoints/UDA_ENet_val/debug', help="Where to save snapshots of the model.")
        ...
        parser.add_argument("--init-weights", type=str, default='../checkpoints/ENet.pth', help="initial model.")
        ...
        parser.add_argument("--source-only", type=bool, default=False, help="train only on original source")
        parser.add_argument("--stylized-only", type=bool, default=False, help="train only on stylized source")
