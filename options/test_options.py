...
class TestOptions():
    def initialize(self):
        ...
        parser.add_argument("--save", type=str, default='../results/pseudo_labels_gray', help="Path to save result.")
        parser.add_argument('--gt_dir', type=str, default='../data/cityscapes/gtFine/val', help='directory for CityScapes val gt images')
        # parser.add_argument('--gt_dir', type=str, default='../data/cityscapes/gtFine/train', help='directory for CityScapes val gt images')
